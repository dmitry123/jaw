...
SELECT pg_catalog.setval('employee_group_id_seq', 35, true);
...
SELECT pg_catalog.setval('employee_id_seq', 20, true);
...
SELECT pg_catalog.setval('group_privilege_id_seq', 12, true);
...
jaw-admin	Администратор	Администратор
\.
...
SELECT pg_catalog.setval('product_employee_id_seq', 15, true);
...
14	test	912f34f975f62df1	test@test.ru
\.
