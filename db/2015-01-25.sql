...
60	Лам	Ламов	8	0	0	31	Ламович	2015-01-24 16:41:44.138
\.
...
SELECT pg_catalog.setval('employee_group_id_seq', 122, true);
...
SELECT pg_catalog.setval('employee_id_seq', 61, true);
...
SELECT pg_catalog.setval('group_privilege_id_seq', 64, true);
...
SELECT pg_catalog.setval('product_employee_id_seq', 57, true);
...
SELECT pg_catalog.setval('request_id_seq', 34, true);
...
COPY ticket (id, creator_id, owner_id, precedence, product_id, project_id, description, parent_id, creation_date, name) FROM stdin;
6	20	20	1	31	-1	\N	-1	2015-01-25 20:53:16.589	Задача 1
7	20	20	2	31	-1	\N	-1	2015-01-25 21:01:50.7	Задача 2
9	20	60	4	31	-1		-1	2015-01-25 21:30:33.718	Задача 4
10	20	58	5	31	-1		-1	2015-01-25 21:30:47.204	Задача 5
11	20	59	2	31	-1		-1	2015-01-25 21:41:24.614	Прочитать Б. Керниган Д. Ритчи
12	20	59	1	31	-1		-1	2015-01-25 21:41:40.762	Сделать курсовую работу
\.
...
SELECT pg_catalog.setval('ticket_id_seq', 12, true);
...
ALTER TABLE ONLY ticket
    ADD CONSTRAINT ticket_created_by_fkey FOREIGN KEY (creator_id) REFERENCES employee(id);
