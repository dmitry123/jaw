...
SELECT pg_catalog.setval('employee_group_id_seq', 118, true);
...
SELECT pg_catalog.setval('employee_id_seq', 58, true);
...
SELECT pg_catalog.setval('product_employee_id_seq', 55, true);
