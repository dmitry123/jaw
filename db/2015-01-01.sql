...
47	Вступил	Вступилов	8	0	0	0	Вступилович	2015-01-01 17:55:35.952
\.
...
SELECT pg_catalog.setval('employee_group_id_seq', 116, true);
...
SELECT pg_catalog.setval('employee_id_seq', 47, true);
...
SELECT pg_catalog.setval('group_privilege_id_seq', 56, true);
...
1	20	47	company/join	Дай вступить!	0
2	20	20	product/join	Hello, World	31
\.
