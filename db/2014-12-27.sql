...
SELECT pg_catalog.setval('company_id_seq', 39, true);
...
22	Мария	Гущина	17	0	0	33	Олеговна
23	Надежда	Левенкова	18	0	0	34	Сергеевна
21	Анастасия	Романова	15	0	0	32	Игоревна
20	Дмитрий	Савонин	8	0	0	31	Александрович
25	Тест	Тестов	22	0	0	37	Тестович
27	Иван	Иванов	8	0	0	39	Иванович
\.
...
SELECT pg_catalog.setval('employee_group_id_seq', 68, true);
...
SELECT pg_catalog.setval('employee_id_seq', 27, true);
...
SELECT pg_catalog.setval('group_privilege_id_seq', 13, true);
...
project-delete	Удалить компанию	Может удалять проекты
\.
...
33	Jaw - N	39	27	2014-12-27 19:47:40.801	0
\.
...
SELECT pg_catalog.setval('product_employee_id_seq', 28, true);
...
SELECT pg_catalog.setval('product_id_seq', 33, true);
...
SELECT pg_catalog.setval('project_id_seq', 18, true);
