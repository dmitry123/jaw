...
import jaw.Html.Indenter.TagIndentSpot;
...
public abstract class MarkupBuilder<T> {
	 ...
	 * The writer should be {@link #setWriter(Writer) bind} before
	 * the builder is used.
	 * 
	 ...
	 * To bind the namespace to the default namespace call:
	 * <p>
	 * {@code ns(null);}
	 ...
	 * the prefix is bind to a non-null non-empty string, the prefix will
	 ...
	 * @param writer never <code>null</code>
	 * @throws IllegalArgumentException if the writer has already been bind or the given writer is null.
	 */
	public final void setWriter(Writer writer) {
		isTrue(this.writer == null, "Writer is already bind.");
		notNull(writer, "writer");
		this.writer = writer;
	}
	...
	public final void done() {
		...
		if (previousBuilder != null) {
			isTrue(previousBuilder.writer == null, 
					"The previous builder has its writer bind. It should not.");
