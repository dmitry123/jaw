...
public abstract class NanoHttpd {
	...
	public Set<Socket> getOpenConnections() {
    ...
    /**
     * Registers that a new connection has been bind up.
     *
     ...
     * <p/>
     * <p>By default, the server spawns a new Thread for every incoming request.  These are bind
        ...
        private String saveTmpFile(ByteBuffer b, int offset, int len) {
            ...
            if (len > 0) {
                ...
                try {
                    ...
                    throw new java.lang.Error(e); // we won't recover, so throw an error
                } finally {
